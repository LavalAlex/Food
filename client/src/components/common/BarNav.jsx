    ...
    return (
        <div className="conteiner-radio">
                <div className="companent-radio">
                    <div className="tabs">
                    <Link to="/createrecipes/"><input type="radio" name="radio1" checked={checked1} value="3" id="tab-1"/>
                        <label for="tab-1" className="tab_1">
                            <p>Create recipes</p>
                        </label></Link> 
                        <Link to="/home/"><input type="radio" name="radio1" value="4" checked={checked2} id="tab-2"/>
                        <label for="tab-2" className="tab_2">
                            <p>Home</p>
                        </label></Link>
                        <Link to="/details/"><input type="radio"  name="radio1" value="5" checked={checked3} id="tab-3"/>
